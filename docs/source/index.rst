anime-recommendation's documentation
================================================

**anime-recommendation** is our Data Management project at University of Milano-Bicocca.
...
We will use two different sources:
   • API from https://aniapi.com;
   • Web Scraping obtained from https://myanimelist.net/.
